...
public class Solution
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        while (true)
        {
            ...
            String tage = reader.readLine();
                if (tage.isEmpty()) break;
            String tweight = reader.readLine();
                if (tweight.isEmpty()) break;
            String ttailLength = reader.readLine();
                if (ttailLength.isEmpty()) break;
            int age = Integer.parseInt(tage);
            int weight = Integer.parseInt(tweight);
            int tailLength = Integer.parseInt(ttailLength);
